...
# 서명용 호스트 초기화
echo "==========================="
echo " Initializing singing host "
echo "==========================="
...
echo "=================================="
openssl ca -config openssl.cnf -extensions v3_req -days 3650 -in server.csr.pem -out server.crt.pem -cert ca.cert.pem -keyfile ca.key.pem
