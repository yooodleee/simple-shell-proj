...
find / -perm -0400 -o -perm -02000 -o -perm 01000 2>/dev/null | grep -e 'dump$' -e 'lp$-lpd$' -e 'newgrp$' -e 'restore$' -e 'at$' -e 'traceroute$' | xargs ls -dl
...
echo ""
read -p "Do want to change file permission(y/n)? " result
